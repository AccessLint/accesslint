...
describe(RULE_ID, () => {
  ...
  it("passes letter-spacing without !important", () => {
    expectNoViolations(
      letterSpacing,
      '<html><body><p style="letter-spacing: 0.05em">Text</p></body></html>',
    );
  });
  ...
  it("passes letter-spacing at threshold (0.12em)", () => {
    expectNoViolations(
      letterSpacing,
      '<html><body><p style="letter-spacing: 0.12em !important">Text</p></body></html>',
    );
  });
  ...
  it("reports letter-spacing below threshold with !important", () => {
    expectViolations(
      ...
      '<html><body><p style="letter-spacing: 0.05em !important">Text</p></body></html>',
      {
        count: 1,
        ruleId: RULE_ID,
        messageMatches: /letter-spacing.*!important|!important.*letter-spacing/,
      },
    );
  });
  ...
  it("passes inherit with !important", () => {
    expectNoViolations(
      letterSpacing,
      '<html><body><p style="letter-spacing: inherit !important">Text</p></body></html>',
    );
  });
