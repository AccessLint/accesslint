...
describe(RULE_ID, () => {
  ...
  it("reports element with tabindex and role=presentation", () => {
    expectViolations(
      ...
      '<div role="presentation" tabindex="0">Focusable</div>',
      {
        count: 1,
        ruleId: RULE_ID,
      },
  ...
  it("reports element with aria-label and role=none", () => {
    expectViolations(
      presentationRoleConflict,
      '<div role="none" aria-label="Named">Content</div>',
      {
        count: 1,
        ruleId: RULE_ID,
  ...
  it("reports element with aria-labelledby and role=presentation", () => {
    expectViolations(
      presentationRoleConflict,
      '<span id="lbl">Label</span><div role="presentation" aria-labelledby="lbl">Content</div>',
      {
        count: 1,
        ruleId: RULE_ID,
      },
  ...
  it("reports element with aria-describedby and role=none", () => {
    expectViolations(
      presentationRoleConflict,
      '<div role="none" aria-describedby="desc">Content</div>',
      {
        count: 1,
        ruleId: RULE_ID,
      },
  ...
  it("reports element with aria-controls and role=presentation", () => {
    expectViolations(
      presentationRoleConflict,
      '<div role="presentation" aria-controls="panel">Content</div>',
      {
        count: 1,
        ruleId: RULE_ID,
      },
  ...
  it("skips aria-hidden elements", () => {
    expectNoViolations(
      presentationRoleConflict,
      '<button role="presentation" aria-hidden="true">Hidden</button>',
    );
  });
  ...
  it("passes tabindex=-1 (not in tab order)", () => {
    expectNoViolations(
      presentationRoleConflict,
      '<div role="none" tabindex="-1">Not in tab order</div>',
    );
  });
});
